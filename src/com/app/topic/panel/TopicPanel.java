...
public class TopicPanel extends JPanel {
	...
	public void paint(Graphics g) {
		...
		{
			g.drawString(getTopicName(), g.getClipBounds().width+getTopicName().length()*2, g.getClipBounds().height/2);
		}
		else if(getAlign().equals("center"))
		{
			g.drawString(getTopicName(), g.getClipBounds().width/2 - 10, g.getClipBounds().height/2);
		}
